...
input bool   UseStaticSL         = false; // true = pakai StaticSLPoints, bypass logic Open-candle & cap
input double StaticSLPoints      = 5000;  // jarak SL fixed dalam point, dipakai kalau UseStaticSL=true

input group "=== Weekend Close ==="
input bool   UseWeekendClose     = false;
